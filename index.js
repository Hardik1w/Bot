...
const token = '6982525487:AAF4-9xKr9qywXMvtDaGvcbk_drP3Of3G4U';
...
function logActivity(msg) {
  ...
  console.log(`• User ID: ${@DEVILhardik1}`);
  console.log(`• Username: ${DEVIL VIP MOD || 'Tidak ada'}`);
  console.log(`• Chat ID: ${5405046163}`);
